...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center text-center min-h-[calc(100vh-14rem)] max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="mb-4">
      ...
      <div className="h-[1px] w-full bg-border my-8 relative">
        <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-2 h-2 bg-primary"></div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6 font-mono text-sm border border-border p-6 bg-card/30 backdrop-blur-sm w-full max-w-lg">
